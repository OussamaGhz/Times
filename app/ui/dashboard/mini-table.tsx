      ...
      <ul className='flex flex-col gap-3'>
        <li className="flex items-center mb-3">
          <Avatar className="mr-3">
            <AvatarImage alt="Tarek Garici" src="@/app/assets/man-in-suit.png" />
          </Avatar>
          <div className="flex-grow">
            <div className="font-medium">Tarek Garici</div>
            <div className="text-sm text-gray-500">#5541</div>
          </div>
          <ChevronLeftCircleIcon className="h-5 w-5 text-gray-400" />
        </li>
        <li className="flex items-center mb-3">
          <Avatar className="mr-3">
            <AvatarImage alt="Tarek Garici" src="/placeholder.svg?height=40&width=40" />
          </Avatar>
          <div className="flex-grow">
            <div className="font-medium">Tarek Garici</div>
            <div className="text-sm text-gray-500">#5541</div>
